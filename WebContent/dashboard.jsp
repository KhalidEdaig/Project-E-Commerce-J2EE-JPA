...
<%
boolean login;
request.setAttribute("modalSecret",true);
if(request.getAttribute("modallogin")!=null){
	login=(Boolean)request.getAttribute("modallogin");
}else{
	login=false;
}
%>
                ...
                <ul class="nav">
                    <li class="active">
                        <!-- <form method="post" action="Controleur">
                            ...
                            <input type="hidden" name="navigation" id="Dashboard" value="Dashboard">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.notify({
            icon: 'pe-7s-gift',
            message: "Welcome to your plate-forme administrator  "
