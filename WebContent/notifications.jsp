                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <p class="category">Handcrafted by our friend <a target="_blank"
                                    href="https://github.com/mouse0270">Robert McIntosh</a>. Please checkout the <a
                                    href="http://bootstrap-notify.remabledesigns.com/" target="_blank">full
                                    documentation.</a></p>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="alert alert-info">
                                        <button type="button" aria-hidden="true" class="close">ÃƒÂ—</button>
