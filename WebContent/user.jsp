                    ...
                    <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" disabled
                                                        placeholder="Company" value="electrokhalid">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control"
                                                        ...
                                                        value="Can help you">Message</textarea>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-user">
                                <div class="image">
                                    <img src="assets/img/gbuser.jpg" alt="..." />
                                </div>
                                <div class="content">
                                    <div class="author">
                                        <a href="#">
                                            ...
                                            <h4 class="title">Khalid<br />
                                                <small>edaigKhalid</small>
                                            </h4>
                                        </a>
                                    </div>
                                    <p class="description text-center"> <br>
                                        <br>
                                        I'm administrator in this plate-forme"
                                    </p>
                                </div>
                                <hr>
